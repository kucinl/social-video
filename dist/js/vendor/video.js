...
(function () {
    ...
    s.vc = function () {
        ...
        if (c = this.options().children)
            if (t.h.isArray(c))
                for (var g = 0; g < c.length; g++) d = c[g],
    ...
    t.mb.prototype.update = function () {
        ...
        for (a = 0; a < g.length; a++) c = g.start(a),
            d = g.end(a), (e = j[a]) || (e = this.b.appendChild(t.e())),
    ...
    function Y(a, c, d) {
        for (var e = a.Fa, g = 0, h = e.length, j, n; g < h; g++) j = e[g],
            j.id() === c ? (j.show(), n = j) : d && (j.K() == d && 0 < j.mode()) && j.disable();
